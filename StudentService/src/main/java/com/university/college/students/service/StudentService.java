package com.university.college.students.service;

import com.university.college.students.dto.Studentdto;
import com.university.college.students.irepository.IStudentRepository;
import com.university.college.students.model.Student;
import com.university.college.students.dto.EnrollmentDto;
...
public class StudentService {
  ...
  StudentService(
    ...
    // ✅ ENROLLMENT SERVICE WITH BASIC AUTH
    _EnrollmentRestClient = restClientBuilder
        .baseUrl("http://localhost:9004/enrollments")
        .defaultHeaders(headers -> headers.setBasicAuth("enrollmentservice", "enrollmentservice") // ✅ AUTH FIX
        )
        .build();

    // ✅ COURSE SERVICE (NO AUTH)
    _CourseRestClient = restClientBuilder
        .baseUrl("http://localhost:9003/courses")
        .defaultHeaders(headers -> headers.setBasicAuth("courseservice", "courseservice"))
        .build();
